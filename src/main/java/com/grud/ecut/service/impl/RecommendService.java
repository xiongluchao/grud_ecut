...
import com.grud.model.MyDataModel;
import com.grud.ecut.dao.MovieDaoI;
import com.grud.ecut.dao.MovieRecommendDaoI;
...
public class RecommendService implements RecommendServiceI {
	...
	/*
	 *  将推荐的电影保存到数据库
	 * @see com.grud.ecut.service.RecommendServiceI#addItem(java.util.List, int)
	 */
	@Override
	...
	public void evaluateUB(int n) throws Exception  {
	    ...
	    DataModel model = new GroupLensDataModel(new File("C:/Users/CHAOCHAO/Desktop/ratings.dat"));
